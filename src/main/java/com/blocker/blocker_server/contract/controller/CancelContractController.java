...
public class CancelContractController {
    ...
    public ResponseEntity<GetCancelContractResponseDto> getCancelingContract(@AuthenticationPrincipal User user,
                                                                             @PathVariable Long cancelContractId) {

        GetCancelContractResponseDto response = cancelContractService.getCancelingContract(user, cancelContractId);
    ...
    public ResponseEntity<GetCancelContractResponseDto> getCanceledContract(@AuthenticationPrincipal User user,
                                                                            @PathVariable Long cancelContractId) {

        GetCancelContractResponseDto response = cancelContractService.getCanceledContract(user, cancelContractId);
