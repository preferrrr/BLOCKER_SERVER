...
import static com.blocker.blocker_server.chat.exception.ChatExceptionCode.IS_NOT_PARTICIPANT;
...
public class IsNotChatParticipantException extends RuntimeException{
    ...
    public IsNotChatParticipantException() {
        super(IS_NOT_PARTICIPANT.getMessage());
        this.exceptionCode = IS_NOT_PARTICIPANT;
    }
}
